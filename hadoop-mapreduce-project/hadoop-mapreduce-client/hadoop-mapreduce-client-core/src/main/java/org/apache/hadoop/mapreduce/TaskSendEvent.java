...
public class TaskSendEvent implements Writable{
    @InterfaceAudience.Public
    @InterfaceStability.Evolving
    /**
    ...
    public static final TaskSendEvent[] EMPTY_ARRAY =
            new TaskSendEvent[0];
    /**
     ...
     */
    protected void setTaskRunTime(int taskSendTime) {
        this.taskRunTime = taskSendTime;
    }
    ...
    public boolean equals(Object o) {
        ...
        if(o.getClass().equals(this.getClass())) {
            TaskSendEvent event = (TaskSendEvent) o;
